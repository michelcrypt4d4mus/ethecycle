...
LONG_NAME = "Based upon public financial disclosures, we can know which politicians in Congress actually have skin in the game. Because searching through financial disclosures can be a time intensive process, this project's goal is to crowdsource the work."
...
def test_extract_wallet_name():
    assert extract_wallet_name(FB_TEST_URL) == 'free.facebook.com/czzharissejoy.biag.5'
    assert extract_wallet_name(FB_TEST_URL2) == 'facebook.com/zzziozaveiro'
    assert extract_wallet_name(LONG_NAME) == 'Based upon public financi...<snip>... to crowdsource the work.'
