...
python -c 'from ethecycle.chain_addresses.coin_market_cap_repo_importer import import_coin_market_cap_repo_addresses; import_coin_market_cap_repo_addresses()'
